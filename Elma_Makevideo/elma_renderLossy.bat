...
:encoding
	...
	echo.
		...
		echo 	[libx264 lossy mode, %frate% fps]
		%ffmpegpath% -nostats -loglevel error -framerate %frate% -i "%fold%\snp%%05d.pcx" -c:v libx264 -r %frate% -pix_fmt nv12 -crf 6 "%fold%".mp4
